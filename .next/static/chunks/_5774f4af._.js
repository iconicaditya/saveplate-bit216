...
function SettingsPage() {
    ...
    const [avatarSrc, setAvatarSrc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("/aaditya-profile.jpg");
    const fileInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const previousAvatarUrlRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsPage.useEffect": ()=>{
            ...
            const observer = new IntersectionObserver({
                "SettingsPage.useEffect": (changes)=>{
                    changes.forEach({
                        "SettingsPage.useEffect": (change)=>{
                            var _entries_find;
                            const tab = (_entries_find = entries.find({
                                "SettingsPage.useEffect": (param)=>{
                                    let [, el] = param;
                                    return el === change.target;
                                }
                            }["SettingsPage.useEffect"])) === null || _entries_find === void 0 ? void 0 : _entries_find[0];
                            if (!tab) return;
                    ...
                    if (visible.size > 0) {
                        ...
                        visible.forEach({
                            "SettingsPage.useEffect": (top, tab)=>{
                                if (top < bestTop) {
                                    bestTop = top;
                                    best = tab;
                                }
            ...
            return ({
                "SettingsPage.useEffect": ()=>{
                    els.forEach({
                        "SettingsPage.useEffect": (el)=>observer.unobserve(el)
                    }["SettingsPage.useEffect"]);
                }
            })["SettingsPage.useEffect"];
        }
    ...
    function scrollTo(tab) {
        var _sectionRefs_current_tab;
        setActiveTab(tab);
        (_sectionRefs_current_tab = sectionRefs.current[tab]) === null || _sectionRefs_current_tab === void 0 ? void 0 : _sectionRefs_current_tab.scrollIntoView({
            behavior: "smooth",
            block: "start"
        });
    }
    ...
    function handleAvatarChange(event) {
        var _event_target_files, _previousAvatarUrlRef_current;
        const file = (_event_target_files = event.target.files) === null || _event_target_files === void 0 ? void 0 : _event_target_files[0];
        if (!file) return;
        const url = URL.createObjectURL(file);
        if ((_previousAvatarUrlRef_current = previousAvatarUrlRef.current) === null || _previousAvatarUrlRef_current === void 0 ? void 0 : _previousAvatarUrlRef_current.startsWith("blob:")) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsPage.useEffect": ()=>{
            return ({
                "SettingsPage.useEffect": ()=>{
                    var _previousAvatarUrlRef_current;
                    if ((_previousAvatarUrlRef_current = previousAvatarUrlRef.current) === null || _previousAvatarUrlRef_current === void 0 ? void 0 : _previousAvatarUrlRef_current.startsWith("blob:")) {
                        URL.revokeObjectURL(previousAvatarUrlRef.current);
                    }
                }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                ...
                children: tabs.map((tab)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: "flex-1 md:flex-none md:w-full items-center justify-center md:justify-start gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors ".concat(isActive ? "bg-gray-100 text-gray-900" : "text-gray-500 hover:text-gray-900 hover:bg-gray-50"),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    settingsSaved && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                        ...
                                                        defaultValue: "Aaditya Chaudhary",
                                                        className: "w-full h-10 px-3 rounded-md border border-gray-200 text-sm focus:outline-none focus:ring-1 focus:ring-gray-300"
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/(app)/settings/page.tsx",
                                                        lineNumber: 197,
                                                        columnNumber: 17
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-gray-500 mt-0.5",
                                        children: "Control what others can see."
                                    }, void 0, false, {
                                        fileName: "[project]/app/(app)/settings/page.tsx",
                                        lineNumber: 229,
                                        columnNumber: 13
                                ...
                                children: [
                                    {
                                        ...
                                        desc: "Allow anyone to see your public donations.",
                                        checked: true
                                    },
                                    {
                                        label: "Private Listings",
                                        desc: "Only allow approved members to see your donations.",
                                        checked: false
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        desc: "Receive mobile push notifications.",
                                        checked: true
                                    }
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "w-10 h-6 rounded-full relative cursor-pointer transition-colors shrink-0 ".concat(item.checked ? "bg-[#4CAF50]" : "bg-gray-200"),
                                                role: "switch",
                                                "aria-checked": item.checked,
                                                tabIndex: 0,
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "w-4 h-4 bg-white rounded-full absolute top-1 transition-all shadow-sm ".concat(item.checked ? "right-1" : "left-1")
                                                }, void 0, false, {
                                                    fileName: "[project]/app/(app)/settings/page.tsx",
                                                    lineNumber: 250,
                                                    columnNumber: 19
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "px-6 pb-6 space-y-4 max-w-md",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-2",
                                        children: [
...
_s(SettingsPage, "pU7ja8ebopFyn+oPI9R8NLljpLQ=");
_c = SettingsPage;
var _c;
...
//# sourceMappingURL=_5774f4af._.js.map