 ...
 */
export async function batchDeleteFoodItems(ids) {
  return apiFetch('/inventory/batch', {
    method: 'DELETE',
    body: { ids },
    requiresAuth: true,
  });
...
/** Fetches user-scoped analytics for a selected reporting range. */
export async function getAnalytics(params = {}) {
  ...
  return apiFetch(`/analytics${suffix ? `?${suffix}` : ''}`, { requiresAuth: true });
}
